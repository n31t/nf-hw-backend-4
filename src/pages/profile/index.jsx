...
export const Profile = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Update username
      const usernameResponse = await axios.put(`http://localhost:3000/api/v5/auth/users/${userId}/username`, {
        username
      }, {
        headers: {
      ...
      if (selectedFile) {
        ...
        const avatarResponse = await axios.put(`http://localhost:3000/api/v5/auth/users/${userId}/image`, formData, {
          headers: {
