...
export const CreatePlaylist = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/v5/playlists', playlistData, {
        headers: {
      ...
      if (img) {
        ...
        const imageResponse = await axios.post(`http://localhost:3000/api/v5/playlists/${response.data._id}/upload-image`, imageFormData, {
          headers: {
